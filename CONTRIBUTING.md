...
This document explains the processes and practices recommended for contributing enhancements to the DNS Operator.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/dns-operators/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/dns-operators)
...
Canonical welcomes contributions to the DNS Operator. Please check out our
...
```
git clone https://github.com/canonical/dns-operators
```
...
OCI image for the DNS app, and then upload the image to a MicroK8s registry,
