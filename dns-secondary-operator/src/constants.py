...
# Certificate storage
PRIVATE_KEY_FILENAME = "dns-secondary.key"
CERTIFICATE_FILENAME = "dns-secondary.pem"
STORED_CERTIFICATE_PATH = f"{DNS_CONFIG_DIR}/{CERTIFICATE_FILENAME}"
STORED_PRIVATE_KEY_PATH = f"{DNS_CONFIG_DIR}/{PRIVATE_KEY_FILENAME}"
