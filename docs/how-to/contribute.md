...
```{note}
See [CONTRIBUTING.md](https://github.com/canonical/dns-operators/blob/main/CONTRIBUTING.md)
for information on contributing to the source code.
```

Our documentation is stored in the `docs` directory alongside the [source code on GitHub](https://github.com/canonical/dns-operators/).
