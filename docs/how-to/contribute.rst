.. meta::
   :description: Familiarize yourself with contributing to the DNS charm documentation.
...
.. note::
   ...
   See `CONTRIBUTING.md <https://github.com/canonical/dns-operators/blob/main/CONTRIBUTING.md>`_
...
`source code on GitHub <https://github.com/canonical/dns-operators>`_.
You may open a pull request with your documentation changes, or you can
`file a bug <https://github.com/canonical/dns-operators/issues>`_
